...
namespace World {
	...
	public:
		...
		Block(OpenGL::Material value) : m_Destroyable(false), m_Liquid(false), m_Toughness(0), m_Material(value) {};
		virtual ~Block() {};

		// Polimorphic getters and setters

		virtual void inline SetMaterial(OpenGL::Material value) { m_Material = value; };
		virtual OpenGL::Material inline GetMaterial(void) { return m_Material; };
