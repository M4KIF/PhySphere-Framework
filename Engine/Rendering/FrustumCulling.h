...
#include<glm.hpp>
#include<Libraries/GLM/matrix.hpp>

/*
* Here I am using an frustum calling algorithm
* implemented by http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
*/
...
inline void Frustum::UpdateFrustum(glm::mat4 m)
{
	m = glm::transpose(m);
	m_planes[Left] = m[3] + m[0];
	m_planes[Right] = m[3] - m[0];
